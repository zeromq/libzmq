...
#ifndef __ZMQ_HVSOCKET_CONNECTER_HPP_INCLUDED__
#define __ZMQ_HVSOCKET_CONNECTER_HPP_INCLUDED__
...
class hvsocket_connecter_t ZMQ_FINAL : public stream_connecter_base_t
{
  public:
  ...
  private:
    ...
    //  Open HVSOCKET connecting socket. Returns -1 in case of error,
    ...
    ZMQ_NON_COPYABLE_NOR_MOVABLE (hvsocket_connecter_t)
};
}
